...
const directionLightHelper = new THREE.Mesh(
    new THREE.PlaneGeometry(),
    new THREE.MeshBasicMaterial({ color: new THREE.Color(0.1, 0.1, 1), side: THREE.DoubleSide })
)
directionLightHelper.position.set(0, 0, 3)
