...
void main()
{
    ...
    // pattern 30
    // float strength = 1.0 - step(0.2, distance(vUv, vec2(0.5)));
    ...
    // pattern 42
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // float strength = mod((angle + PI) / (2.0 * PI) * 20.0, 1.0);
    ...
    // pattern 48
    // float strength = cnoise(vUv * 10.0);
    // strength = 1.0 - step(0.2, strength);
    ...
    // pattern 51
    // float strength = step(0.2, abs(cnoise(vUv * 10.0)));
    ...
    // pattern 54
    // float strength = step(0.2, sin(cnoise(vUv * 10.0) * 20.0));
