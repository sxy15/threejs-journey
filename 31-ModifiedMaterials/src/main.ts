...
// Textures
const mapTexture = textureLoader.load(new URL('@/assets/models/LeePerrySmith/color.jpg', import.meta.url).href)
mapTexture.colorSpace = THREE.SRGBColorSpace
const normalTexture = textureLoader.load(new URL('@/assets/models/LeePerrySmith/normal.jpg', import.meta.url).href)
...
gltfLoader.load(
    ...
    (gltf) =>
    {
        ...
        mesh.customDepthMaterial = depthMaterial // 自定义深度材质
