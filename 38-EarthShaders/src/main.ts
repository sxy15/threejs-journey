...
// Textures
const earthDayTexture = textureLoader.load(new URL('./assets/earth/day.jpg', import.meta.url).href)
earthDayTexture.colorSpace = THREE.SRGBColorSpace
earthDayTexture.anisotropy = 8
const earthNightTexture = textureLoader.load(new URL('./assets/earth/night.jpg', import.meta.url).href)
earthNightTexture.colorSpace = THREE.SRGBColorSpace
earthNightTexture.anisotropy = 8
const earthSpecularCloudsTexture = textureLoader.load(new URL('./assets/earth/specularClouds.jpg', import.meta.url).href)
